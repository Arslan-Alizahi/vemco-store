      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <Cookie className="h-12 w-12 text-caramel-600" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold text-text-primary text-center mb-4">Cookie Policy</h1>
        ...
        >
          <Card className="p-8 space-y-8">
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">What Are Cookies?</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">Types of Cookies We Use</h2>

              <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-text-primary mb-2">1. Essential Cookies</h3>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-text-primary mb-2">2. Performance Cookies</h3>
                  <p className="text-bark-700">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-text-primary mb-2">3. Functionality Cookies</h3>
                  <p className="text-bark-700">
                ...
                <div className="bg-amber-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-text-primary mb-2">4. Targeting/Advertising Cookies</h3>
                  <p className="text-bark-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">Third-Party Cookies</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
              ...
              <div className="bg-canvas p-4 rounded-lg">
                <h3 className="font-semibold text-text-primary mb-2">Third-party services we use:</h3>
                <ul className="list-disc list-inside space-y-1 text-bark-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">Managing Your Cookies</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
                You have the right to decide whether to accept or reject cookies. You can exercise your cookie preferences by:
              </p>
              <ul className="list-disc list-inside space-y-2 text-bark-700 ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">Browser-Specific Instructions</h2>
              <div className="space-y-3">
                <div className="p-3 bg-canvas rounded">
                  <p className="text-bark-700"><strong>Chrome:</strong> Settings → Privacy and security → Cookies and other site data</p>
                </div>
                <div className="p-3 bg-canvas rounded">
                  <p className="text-bark-700"><strong>Firefox:</strong> Options → Privacy & Security → Cookies and Site Data</p>
                </div>
                <div className="p-3 bg-canvas rounded">
                  <p className="text-bark-700"><strong>Safari:</strong> Preferences → Privacy → Manage Website Data</p>
                </div>
                <div className="p-3 bg-canvas rounded">
                  <p className="text-bark-700"><strong>Edge:</strong> Settings → Privacy, search, and services → Cookies and site permissions</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">Updates to This Policy</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-4">Contact Us</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
                If you have any questions about our use of cookies, please contact us:
              </p>
              <div className="bg-caramel-50 p-4 rounded-lg">
                <p className="text-bark-700"><strong>Email:</strong> privacy@vemco.pk</p>
                <p className="text-bark-700"><strong>Address:</strong> 123 Commerce Street, Suite 100, New York, NY 10001</p>
                <p className="text-bark-700 mt-2">
                  <a href="/contact" className="text-caramel-600 hover:text-caramel-700 underline">
                    Contact Support
                  </a>
                </p>
              </div>
